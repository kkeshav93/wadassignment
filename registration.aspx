    ...
    <form id="form1" runat="server">
        ...
        <div class="registration-form" style="height:500px" >
            ...
            <div class="rightside">
                ...
                <asp:RequiredFieldValidator ID="SSNValidator" ControlToValidate="TextBox1" runat="server" ErrorMessage="RequiredFieldValidator" style="font-size:10px; color:red"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="SSNValidatorRegularExpressionValidator" ControlToValidate="TextBox1" runat="server" ErrorMessage="Wrong Social Security Number" ValidationExpression="\d{3}-\d{2}-\d{4}" style="font-size:10px; color:red"></asp:RegularExpressionValidator>
                <br />
                ...
                <br />
                <asp:TextBox ID="TextBox6" TextMode="Password" runat="server" ></asp:TextBox><mark class="hello1" style="font-size:15px">?<span class="hello">Password must be between 8 and 10 characters, contain at least one digit
